...
//					System.out.println("visit jar:"+name);
		...
		registClass(ScalaActorProvider.class, rsproxy);
...
//									break;
									...
									System.out.println("add NActorProvider PojoClass:"+name);
									render.addPojoClass(name.replace('/', '.').replaceAll(".class", ""));
									break;
								}
								if (attrcopy.toString().equals("@" + ScalaActorProvider.class.getName())) {
									founded = true;
//									break;
									System.out.println("addScalaPojoClass:"+name);
									render.addPojoClass(name.replace('/', '.').replaceAll(".class", ""));
									break;
								}
